...
namespace PopulationTask.Tests
{
    public class PopulationTests
    {
        ...
        public int GetYears_Return_Count_Of_Years_Another_Format()
        {
            // Act
            int years = Population.GetYears(2000, 10, 250, 3000);
            return years;

            // Assert
            Assert.AreEqual(3, Population.GetYears(2000, 10, 250, 3000));
        }
